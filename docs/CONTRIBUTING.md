...
2. Clone your fork:
   `git clone https://github.com/your-username/awesome-stars.git`.
3. Navigate to the project: `cd awesome-stars`.
4. Create a new branch: `git checkout -b feat/my-feature`.
5. Make your changes.
